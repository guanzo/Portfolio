<template>
    <svg id="man-svg"viewBox="0 0 508 508">
        <g id="man-portrait">
            ...
            <path :fill="tieColor1" d="m288 372l-12 26h-44l-12.8-25.6c17.6-7.6 34.8-8.8 34.8-8.8s17 2 34 9z" />
            <path :fill="tieColor2" d="m218 506c11.6 1.6 23.6 2.4 36 2.4 12 0 24-0.8 36-2.4l-14-107h-44l-14 107z" />
            <g fill="#fff">
...
export default {
    ...
    computed: {
        tieColor1(){
            return this.$store.getters.currentGradient[0]
        },
        tieColor2(){
            return this.$store.getters.currentGradient[1]
        }
    }
}
